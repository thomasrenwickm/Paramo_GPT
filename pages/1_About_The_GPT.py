...
st.markdown(" can talk about rag, the model it uses (gemini 2.0 flash), how it is connected (using langachian), the retriever, the vector db etc")

st.markdown("""## FAISS vs. Chroma:
